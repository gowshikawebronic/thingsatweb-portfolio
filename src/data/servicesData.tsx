...
`,
  },
  {
    ...
    image: "./assets/images/dataanaly.png",
    href: "/services/data-analytics",
    icon: Cpu,
    description: `Data is your organization's most valuable asset, but only if you can transform it into actionable insights. Many businesses struggle with data trapped in silos (ERP, CRM, spreadsheets), manual reporting bottlenecks, and scalability issues
