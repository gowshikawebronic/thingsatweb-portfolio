      ...
      >
        <div className="flex items-center justify-between px-4 py-3 relative">
          ...
          <div className="hidden lg:flex items-center gap-4 shrink-0">
            <Link
              href="/contact"
              className="inline-flex items-center rounded-full bg-brand-green px-6 py-2.5 text-sm font-bold text-white  transition-all hover:scale-105 hover:bg-[#4F86E8] active:scale-95"
            >
              Let’s Talk
            </Link>
          </div>
