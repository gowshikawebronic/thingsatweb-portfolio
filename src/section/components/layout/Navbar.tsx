        ...
        <div className="flex items-center justify-between px-4 py-3 relative">
          ...
          <div className="hidden lg:flex items-center justify-center flex-1 px-8">
            <ul className="flex items-center gap-8 text-[15px] font-medium text-slate-700">
              ...
              >
                <button 
                  className="flex items-center gap-2 rounded-full px-3 py-1.5 text-sm font-medium hover:bg-black/5 transition-colors"
                >
                  <Image
                ...
                >
                  ...
                  >
                    <Image src="./assets/logo/sweden.png" alt="SV" width={20} height={20} className="rounded-full object-cover" />
                    Swedish
                  </Link>
                </div>
              </li>
          ...
          <div className="lg:hidden block">
            <button 
              ...
              className="relative z-50 flex items-center justify-center w-10 h-10 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-900 transition-colors focus:outline-none"
            >
        ...
        >
          <ul className="flex flex-col gap-1 p-2">
            <li>
              <Link 
                href="/" 
                className="block p-3 rounded-xl hover:bg-slate-50 text-base font-bold text-slate-800 hover:text-brand-green transition-colors"
            ...
            <li className="rounded-xl overflow-hidden bg-slate-50/50">
              <button
                ...
                className="flex w-full items-center justify-between p-3 rounded-xl text-base font-bold text-slate-800 hover:text-brand-green transition-colors"
              >
                Services
                <ChevronDown 
                  size={18} 
              ...
              <div 
                className={`transition-all duration-300 ease-in-out overflow-hidden ${mobileServicesOpen ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"}`}
              >
            ...
            <li className="mt-2 pt-2 border-t border-slate-100">
               <button
                ...
                className="flex w-full items-center justify-between p-3 rounded-xl hover:bg-slate-50 text-base font-medium text-slate-600 transition-colors"
              >
              ...
              <div className={`transition-all duration-300 overflow-hidden ${mobileLangOpen ? "max-h-20 opacity-100" : "max-h-0 opacity-0"}`}>
                 <Link
                  href="/lang/sv"
                  className="flex items-center gap-3 p-3 pl-4 rounded-xl hover:bg-slate-50 text-base text-slate-600 hover:text-brand-green"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  <Image src="./assets/logo/sweden.png" alt="SV" width={24} height={24} className="rounded-full" />
                  Swedish
                </Link>
              </div>
            </li>
            ...
            <li className="mt-2">
              <Link
                href="/contact"
                onClick={() => setIsMobileMenuOpen(false)}
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-brand-green px-6 py-4 font-bold text-white shadow-lg transition-all active:scale-95"
              >
                Let’s Talk
                <ArrowRight size={18} />
              </Link>
